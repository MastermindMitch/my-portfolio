...
<div class="project-container">
  ...
  <div class="details">
    <p><strong>Filament Guide:</strong>Shows everything there is to need to know about a 3D printable material in one place.</p>

    <p><strong>Slicer Guide:</strong>Shows how to use the software for 3D printing for future employees. Has basic information through advanced for fine tuning prints.</p>

    <p><strong>Results:</strong>The documents have a combined length of over 150 pages.</p>

    <p><strong>Software:</strong>Microsoft Visio</p>
  </div>
