...
<div class="resume-wrapper">
  <div class="resume-header">
    <h1>Resumé</h1>
    <a href="/images/MitchellHenryResume.pdf" class="download-btn" download>Download PDF</a>
  </div>

  <div class="resume-display">
    <embed src="/images/MitchellHenryResume.pdf#toolbar=0&view=FitH" type="application/pdf">
  </div>
</div>
{{< /rawhtml >}}
